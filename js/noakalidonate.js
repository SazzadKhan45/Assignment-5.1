...
.addEventListener('click', function(){
    // Validation function
    const inputNumber = getInputByIdValue('input-money-value-2');
    if(isNaN(inputNumber)){
        alert('Your input is not a number');
        document.getElementById('input-money-value-2').value = '';
        return;
    }

    // get feni donate blance 
    const textNumber = getTextbyIdValue('noakali-donate-balance');
    const newBalance = inputNumber + textNumber;
    console.log(newBalance);
    document.getElementById('noakali-donate-balance').innerText = newBalance;
    // Main balanace 
    ...
    div.innerHTML = `
        <div class = "bg-orange-200 rounded-lg py-5 px-5 text-black my-5">
            ...
            <p>Noakhali donation total amount : ${newBalance} Tk</p>
            <p>Noakhali donation amount : ${inputNumber} Tk</p>
